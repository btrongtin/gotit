...
function ListGoalDropdown(props) {
    const {setCreateBoardModalOpen, setEditGoalModalOpen, setListUserModalOpen} = props
    ...
    return (
        <div className="relative inline-flex ml-3">
            ...
            <Transition
                className="origin-top-right z-10 absolute top-full right-0 min-w-[12rem] bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
                show={dropdownOpen}
                    ...
                    <ul>
                        ...
                        <li>
                            <button
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    setListUserModalOpen(true)
                                    setDropdownOpen(false)
                                }}
                            >
                                <span>Add user to this board</span>
                            </button>
                        </li>
                        <li>
                            <button
...
export default ListGoalDropdown;
